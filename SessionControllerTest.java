...
class SessionControllerTest {
  ...
  public void testControlInput() throws IOException {
    String input = "src/SampleFiles/OutputExamples/ComputerPath.sr\n"
        + "4\n3\n1\n3\n";
    ...
    String zeroInput = "src/SampleFiles/OutputExamples/ComputerPath.sr\n"
        + "0\n";
    ...
    String inputExit = "src/SampleFiles/OutputExamples/ComputerPath.sr\n"
        + "4\n2\n";
    ...
    String inputInvalid = "src/SampleFiles/OutputExamples/ComputerPath.md\n"
        + "src/SampleFiles/OutputExamples/ComputerPath.sr\n"
        + "4\n1\n4\n3\n";
